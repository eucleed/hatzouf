...
import org.castafiore.iot.definitions.InteractionDefinition;
...
public class Device implements OnConnectedListener {
	...
	public Device(String deviceId, String name, String label, String icon) {
		definition = new DeviceDefinition();
		definition.setDeviceid(deviceId);
	...
	public Device registerEvent(String name, String description) {
		...
		if (definition.getInteraction() == null) {
			definition.setInteraction(new InteractionDefinition());
		}
		definition.getInteraction().getEvents().add(event);
		return this;
	}

	public void handshake() {
		UpStream up = new UpStream();
		up.setDeviceId(definition.getDeviceid());
	...
	public void propagateEvent(String event, Map<String, String> parameters) {
		...
		request.setDeviceId(definition.getDeviceid());
	...
	public Device registerFunction(String name, String description) {
		...
		definition.getInteraction().getFunctions().add(function);
		return this;
	...
	public void onConnected(Device device) {
		...
		stream.setDeviceId(definition.getDeviceid());
